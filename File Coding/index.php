...
<html lang="en">
    <head>
        ...
        <title>Beranda - Masjid Al Ikhlas</title>
        <!-- Favicon-->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="data.php">Data Keuangan</a></li>
            ...
            <div class="row text-center">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card h-100">
                        <img class="card-img-top" src="assets/img/masjid 2.jpeg" alt="..." />
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card h-100">
                        <img class="card-img-top" src="assets/img/masjid 1.jpeg" alt="..." />
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card h-100">
                        <img class="card-img-top" src="assets/img/masjid_8.jpeg" alt="..." />
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card h-100">
                        <img class="card-img-top" src="assets/img/masjid_7.jpeg" alt="..." />
                        <div class="card-body">
