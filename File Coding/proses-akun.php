<?php
    ...
    function registrasi($data)
    {
        ...
        $result = mysqli_query($conn, "SELECT username FROM tbl_akun WHERE username='$username' ");
        ...
        mysqli_query($conn, "INSERT INTO tbl_akun (username, password) VALUES('$username', '$password')");
